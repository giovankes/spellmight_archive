...
class PhaserDefaultScene extends Phaser.Scene {
  ...
  create() {
    const background = this.add
      .image(0, 0, CST.IMAGE.STAGES.TEST.BACKGROUND)
      .setOrigin(0);
    ...
    this.walkLeft = this.anims.create({
      key: "left",
      frames: this.anims.generateFrameNumbers(CST.SPRITESHEET.CHARACTERS.TEST, {
        start: 0,
        end: 3,
      }),
      frameRate: 10,
